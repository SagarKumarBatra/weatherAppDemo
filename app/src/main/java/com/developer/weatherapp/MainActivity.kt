package com.developer.weatherapp
...
import com.developer.weatherapp.databinding.ActivityMainBinding
import com.developer.weatherapp.models.WeatherResponse
import com.developer.weatherapp.network.WeatherService
...
class MainActivity : AppCompatActivity() {
            ...
            Dexter.withActivity(this).withPermissions(
                ...
                override fun onPermissionsChecked(report: MultiplePermissionsReport?) {
                    ...
                    if(report.isAnyPermissionPermanentlyDenied){
                        ...
                        "You have denied location Permissions, Please enable them as it is mandatory for service ",
                                Toast.LENGTH_SHORT).show()
                    }
                }

                override fun onPermissionRationaleShouldBeShown(report: MutableList<PermissionRequest>?, p1: PermissionToken?) {
        ...
        if(Constants.isNetworkAvailable(this)){
            ...
            listCall.enqueue(object : Callback<WeatherResponse>{
                ...
                override fun onFailure(p0: Call<WeatherResponse>, p1: Throwable) {
                    Log.e("Errorrrrr", p1.message.toString())
                    hideProgressDialog()
                }
            })
    ...
    private fun showRationalDialogForPermissions(){
        AlertDialog.Builder(this)
                .setMessage("It looks like you turned off permissions required for location, it can be enabled in settings.")
